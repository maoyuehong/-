<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\WWW\thinsone\public/../application/admin\view\member\area.html";i:1509954486;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row m-b-xs">
        ...
        <div class="col-sm-9">
            <button class="btn btn-primary btn-xs" type="button"  style="text-align: left" >当前会员账号:<?php echo $rou['m_user']; ?>【<?php echo $rou['m_mobile']; ?>】</button>
        </div>
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td colspan="100" align="left">
                ...
                <button class="btn btn-success btn-xs" type="button" >总业绩:<?php echo \think\Request::instance()->session('money'); ?></button>
            </td>
        </tr>
        </tfoot>
        </tbody>
...
<script type="text/javascript">
    ...
    function look2(id ,cont) {
        ...
        window.location='__URL__/area?index=<?php echo $index; ?>&id='+id;
    }
