<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\WWW\thinsone\public/../application/admin\view\profit\showlist.html";i:1509766547;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
  ...
  <table class="table table-hover">
    ...
    <tr>
      ...
      <td>
        <?php switch($v['p_state']): case "1": ?>处理中<?php break; case "2": ?>已成功<?php break; endswitch; ?></td>
      <td><?php echo date("Y-m-d H:i:s",$v['p_time']); ?></td>
      <td>
      <!--  <a href="<?php echo url('upd',array('p_id'=>$v['p_id'])); ?>"><button class="btn btn-success btn-xs" type="button" ><i class="fa fa-edit"></i> 编辑</button></a>-->
